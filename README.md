...
| 6 <br> ([D6](#day-6-202076)) | 7 <br> ([D7](#day-7-202077)) | 8 <br> ([D8](#day-8-202078))            | 9 <br> ([D9](#day-9-202079))            | 10 <br> ([D10](#10))         | 11                | 12                |
...
打算等代码合并以后开始写线段树和伙伴系统相关；

### 事件2：rust 练习

尝试开始写了一小部分 rust 的 hardway 练习；
